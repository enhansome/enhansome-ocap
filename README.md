...
* rust
  ...
  * [Tenuo](https://github.com/tenuo-ai/tenuo) ⭐ 79 | 🐛 28 | 🌐 Rust | 📅 2026-07-13 - Capability-based authorization for AI agents. Uses cryptographic warrants with offline attenuation to enforce least-privilege boundaries on LLM tool calls.
